  ...
  const handleSendReply = async () => {
    try {
      const response = await api.put(
        `/admin/inquiry/reply/${selectedItem._id}`,
        {
          reply,
        },
      );
   ...
   const DeleteInquiry = async (id) => {
    try {
      await api.delete(`/admin/inquirary/delete/${id}`);
            ...
            >
              <div className="card-body p-4">
                <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                  <div>
                    <h2 className="text-white fw-bold mb-1">Manage Inquiry</h2>

                    <p className="text-light mb-0">
                      Professional Inquiry Management Panel
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  >
                    ...
                    >
                      <tr>
                        ...
                        <th className="text-white py-4">Subject</th>
        ...
        >
          <div className="modal-dialog modal-dialog-centered modal-lg">
            ...
            >
              ...
              >
                <div>
                  <h4 className="text-white fw-bold mb-1">Reply to Inquiry</h4>

                  <p className="text-light mb-0">
                    Send professional inquiry response
                  </p>
                </div>
              ...
              <div className="modal-body p-4">
                ...
                >
                  ...
                  >
                    ...
                    <p className="mb-0 fw-semibold">{selectedItem?.subject}</p>
                  </div>
